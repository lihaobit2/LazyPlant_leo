...
void Pro_W2D_Control_DevceHandle(void)
{
	...
	{
		case SET_MODE:
			Device_WirteStruct.Mode_set = Pro_P0_ControlStruct.Device_Wirte.Mode_set;
			printf("Set mode:%d  \r\n", Device_WirteStruct.Mode_set);
			if(Pro_P0_ControlStruct.Device_Wirte.Mode_set == MANUAL_MODE)
			{
				printf("Set manual mode  \r\n");
			}
			if(Pro_P0_ControlStruct.Device_Wirte.Mode_set == AUTO_MODE)
			{
		...
		case SET_PUMP_SWITCH:	
			...
			if(Pro_P0_ControlStruct.Device_Wirte.Pump_Switch == PUMP_ON)
			{
				printf("Pump on  \r\n");
			}
			if(Pro_P0_ControlStruct.Device_Wirte.Pump_Switch == PUMP_OFF)
			{
				printf("Pump off  \r\n");
			}
...
void Pro_D2W_ReportDevStatusHandle(void)
{
	...
	Pro_D2W_ReportStatusStruct.Device_All.Device_Read.Temperature = Device_ReadStruct.Temperature;
	Pro_D2W_ReportStatusStruct.Device_All.Device_Read.Light_inten = Device_ReadStruct.Light_inten;	
